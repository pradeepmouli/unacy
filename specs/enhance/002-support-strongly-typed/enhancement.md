...
- Update unit creation functions (createUnit, defineUnit, etc.) to accept optional metadata parameter
...
4. [ ] Update unit creation functions to accept optional metadata parameter and migrate tag parameter to metadata.name
...
8. [ ] Add comprehensive unit tests for metadata functionality (creation, access, type safety, immutability, withMetadata behavior, type-level behavior)
